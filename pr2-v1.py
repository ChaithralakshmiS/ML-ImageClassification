...
y_pred_et=clf_et.predict(X_test_fs)
...
X_ab=X_sm
y_ab=y_sm
clf_ab=ExtraTreesClassifier()
clf_ab.fit(X_ab,y_ab)
y_pred_ab=clf_ab.predict(X_test_fs)
print('Adaboost : f1_score = ',f1_score(y_test, y_pred_ab,average='weighted'))
...
print(y_pred_test)
np.savetxt('pr2-nov1-vc-v1.dat', y_pred_test, delimiter=" ", fmt="%s")
